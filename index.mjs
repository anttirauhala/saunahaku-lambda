...
const result = [
    {
        ...
        "info": "Kassa sulkeutuu 30 min ennen päättymisaikaa. Maksuvälineeksi suositellaan pankkikorttia. Su klo 19-21 hiljainen sauna.",
        "kiosk": true,
        "restaurant": false
    },
    {
        ...
        "info": "Kesäosoite: Ratinan rantatie 6, Ratinan stadionin edustalla. Pikkupurtavaa ja keittoa arkisin, viikonloppuisin lisänä aamiainen. Voit piipahtaa kahville tai drinkille ohikulkumatkalla. Voit myös vuokrata pyyhkeen. Talvikausi Pyynikillä: tiedotetaan lisää lokakuussa.",
        "kiosk": true,
        "restaurant": true
    },
    {
    ...
    },*/
    {
        ...
        "info": "Tahmelan Huvilan kaksi saunaa Pyhäjärven rannalla. Oma puulämmitteinen sisäsauna ja 1.9.2024 avattu Rantaportti- pihasauna. Mahdollisuus kastautua Pyhäjärvessä myös talvisin. HUOM! NAISTEN VUORO TO KLO 19-21. Kesäkausi 1.6.-30.9.2025.",
        "kiosk": true,
        "restaurant": false
    },
    {
